...
/**
 * A modal component for updating user details such as username, role, and password.
 *
 * @component
...
const UpdateUserModal: React.FC<UpdateUserModalProps> = ({
  ...
  /**
   * Resets form fields when the modal opens.
   */
  useEffect(() => {
    if (open) {
  ...
  /**
   * Handles updating the user by sending a PUT request to the backend.
   * 
   * @async
